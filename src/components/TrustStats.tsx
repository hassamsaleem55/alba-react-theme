...
export default function TrustStats() {
  const stats = [
    ...
    { number: "500+", label: "Cars Sold Monthly", icon: Car, color: "from-green-500 to-emerald-500" },
    { number: "98%", label: "Customer Satisfaction", icon: TrendingUp, color: "from-purple-500 to-pink-500" },
    { number: "24/7", label: "Customer Support", icon: Headphones, color: "from-red-500 to-rose-500" },
    { number: "50+", label: "Service Centers", icon: Building2, color: "from-indigo-500 to-blue-600" },
  ];
        ...
        <MotionReveal preset="fadeIn">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Built on <span className="text-primary">Trust</span>, Driven by Results
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Real numbers that showcase our commitment to automotive excellence and customer satisfaction
            </p>
          </div>
        </MotionReveal>
            ...
            return (
              <MotionReveal key={stat.label} preset="slideUp" delay={index * 0.1}>
                <div className="group bg-white/10 backdrop-blur-sm hover:bg-white/15 rounded-2xl p-6 text-center transition-all duration-300 hover:shadow-xl border border-white/20 hover:border-white/30 hover:-translate-y-1">
                  <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br ${stat.color} text-white mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
        ...
        <MotionReveal preset="fadeIn" delay={0.6}>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-white/20 text-center">
            ...
            <p className="text-gray-300 leading-relaxed max-w-3xl mx-auto">
              These aren't just statistics – they represent thousands of successful car purchases, 
              countless satisfied families, and our unwavering commitment to automotive excellence.
            </p>
          </div>
        </MotionReveal>
      </div>
