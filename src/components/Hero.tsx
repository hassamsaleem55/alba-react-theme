...
export default function Hero() {
  return (
    <div className="relative flex justify-center items-center pb-6 md:px-5 bg-linear-to-b from-white to-transparent md:bg-white h-[calc(100vh-5.5rem)] md:rounded-b-[4rem]">
      <img
        src="images/hero-image.jpg"
        alt="Hero Section"
        className="w-full h-full rounded-4xl md:rounded-[3.5rem] object-cover brightness-50"
      />
